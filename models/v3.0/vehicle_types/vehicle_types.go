...
import (
	"github.com/PhD-Kerger/gbfs-go-adapter/models/golang/common"
	"github.com/PhD-Kerger/gbfs-go-adapter/models/golang/v3.0/header"
)
...
type VehicleType struct {
	...
	EcoLabels []common.EcoLabel `json:"eco_labels,omitempty"`
	...
	Make []common.LocalizedString `json:"make,omitempty"`
	...
	// following keys:
	Model []common.LocalizedString `json:"model,omitempty"`
	// The public name of this vehicle type. An array with one object per supported language
	// with the following keys:
	Name []common.LocalizedString `json:"name,omitempty"`
